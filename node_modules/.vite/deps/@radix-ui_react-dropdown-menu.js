...
var FocusScope = React12.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime10.jsx)(Primitive3.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React22.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime18.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React22.isValidElement(newElement) ? React22.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable6(child) {
  return React22.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var Portal = React24.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime20.jsx)(Primitive6.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React25.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime21.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React25.isValidElement(newElement) ? React25.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var MenuContent = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(Collection.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime23.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime23.jsx)(Collection.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime23.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime23.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
...
var Slot8 = createSlot7("MenuContent.ScrollLock");
var MenuContentImpl = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    const scrollLockWrapperProps = disableOutsideScroll ? { as: Slot8, allowPinchZoom: true } : void 0;
...
var MenuGroup = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(Primitive7.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(Primitive7.div, { ...labelProps, ref: forwardedRef });
  }
);
...
var MenuSubContent = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React36.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime23.jsx)(Collection.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime23.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime23.jsx)(Collection.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime23.jsx)(
      MenuContentImpl,
      {
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime24.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime24.jsx)(Root3, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
